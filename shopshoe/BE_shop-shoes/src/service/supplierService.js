...
const createNewSuppiler = async (data) => {
  try {
    ...
    return {
      errCode: 0,
      errMessage: "Thêm thương hiệu thành công",
      DT: [], //data
    };
  } catch {
...
const getAllSuppliers = async () => {
  try {
    ...
    if (supp) {
      return {
        errCode: 0,
        errMessage: "Lấy data thương hiệu thành công",
        DT: supp, //data
      };
    } else {
      return {
...
const deleteSupplier = async (id) => {
  try {
    ...
    if (supp) {
      ...
      return {
        errCode: 0,
        errMessage: "Xóa thương hiệu thành công",
        DT: [], //data
      };
    } else {
      return {
        errCode: 2,
        errMessage: "thương hiệu này không tồn tại",
        DT: [], //data
      };
    }
  } catch (error) {
...
const updateSupplier = async (data) => {
  try {
    ...
    if (supp) {
      ...
      return {
        errCode: 0,
        errMessage: "Cập nhật thương hiệu thành công",
        DT: "", //data
      };
    } else {
      return {
        errCode: 2,
        errMessage: "Ko tìm thương hiệu",
        DT: "", //data
      };
    }
  } catch (error) {
